...
public class QuestionRepository implements IQuestionRepository {
    ...
    public List<Question> findAll() {
        ...
        List<Question> allQuesitonList = new ArrayList<>();
        for(Question q : questionMap.values()){
            allQuesitonList.add(q);
        }
        return allQuesitonList;
    }
    ...
    public List<Question> findAllQuestionLevelWise(Level level) {
        ...
        List<Question> allQuesitonListLevelWise = new ArrayList<>();
        for(Question q : questionMap.values()){
            if(q.getLevel() == level)
                allQuesitonListLevelWise.add(q);
        }
        return allQuesitonListLevelWise;
    }
